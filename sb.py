                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['yg tag gw , kangen ya ?????','ada apa ini? ko di tag? mau ngasih duit ya????','duhh kena tag, dianya kesepian kali yah????','gk usah tag, gift tikel aja????']
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['Eh ada ka@']
                                client.sendText(op.param1, str(random.choice(pref))+' '+Name)=['ngapain ngintip...?? sini gabung chat']
                        else:
                            pass
                    else:
                        pass
